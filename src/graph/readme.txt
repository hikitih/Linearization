...
Свойства:
	...
	inWeights	-- входящие веса (соответствуют вершинам с тем же индексом в массиве)
	outWeights	-- исходящие веса (соответствуют вершинам с тем же индексом в массиве)
Методы:
	ClearEdges	-- удаляет все ребра из вершины и обнуляет степени
	addInEdge,
	addOutEdge,
	deleteInEdge,
	deleteOutEdge	-- делают то, что написано в названии. Одновременно контролируются веса и степени (входящие/исходящие)
